use crate::{
    ...
    Port, PortProtocol, Result, Stage, User, DOCKERFILE_VERSION, REPOSITORY, VERSION,
};
...
impl DockerfileGenerator for Image {
    fn generate_dockerfile_lines(
        ...
        let mut lines = vec![
            DockerfileLine::Comment(format!("This file is generated by Dofigen v{}", VERSION)),
            DockerfileLine::Comment(format!("See {}", REPOSITORY)),
